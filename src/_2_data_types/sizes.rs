...
pub fn main() {
  ...
  println!("The size of a type in memory is the same in all operating systems, but the size of the memory can change depending on the operating system.\n");
  println!("The usize / isize type is the same size as the pointer size of the computer's architecture.\n");
  println!("If my computer uses a 64-bit architecture, the usize / isize type will be 64 bits, and if it uses a 32-bit architecture, the usize / isize type will be 32 bits.\n");
